...
public class ModItems {
    ...
    public static final Item DEEPSLATE = register("music_disc_deepstate", ModSounds.SOUND_DEEPSTATE);
    public static final Item DESCENT = register("music_disc_deepslate", ModSounds.SOUND_DESCENT);
